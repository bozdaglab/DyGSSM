...
if __name__ == '__main__':
    ...
    if model_type == "wingnn":
        from main_models.main_wingnn_settings import main
        args = load_args_wingnn(path_1)
        main(args, path, path_1,  model_type)
    elif model_type == "hawkes":
        from main_models.main_hawkes_settings import main
        args = load_args_haks()
        main(args, path_1, model_type)